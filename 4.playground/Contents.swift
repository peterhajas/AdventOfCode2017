...
func passphraseIsValid(_ passphrase: String) -> Bool {
    let components = passphrase.components(separatedBy: " ")
    let componentsSet = Set(components)
    
    return components.count == componentsSet.count
}

func passphrasesInList(_ list: String) -> [String] {
    let components = list.components(separatedBy: CharacterSet.newlines)
    return components
}

func numberOfValidPassphrasesInList(_ list: String) -> Int {
...
// Example
print(numberOfValidPassphrasesInList("aa bb cc dd ee"))
